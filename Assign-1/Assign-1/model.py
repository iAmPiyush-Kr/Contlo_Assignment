...
# Comment below code when using Casual Attention Mechanism (Inbult one)
...
# Uncomment the below code when not using Multi-Head Attention
...
# Below function is for Point Wise feed forward
...
# Below function is for Position Wise feed forward
...
class Block(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.pos_ffn = PointwiseFeedForward(d_model, d_hidden)
...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.transformer = nn.ModuleDict(dict(
            wte = nn.Embedding(config.vocab_size, config.n_embd),    # this given token
            wpe = nn.Embedding(config.block_size, config.n_embd),    # this gives embedding
